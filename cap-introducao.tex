...
As solução de software livre de CEP disponíveis na atualidade\footnote{ \url{http://esper.espertech.com/},  \url{http://www.drools.org/},  \url{https://docs.wso2.com/display/CEP420}} %(e.g., \todo{Incluir aqui a citação a essas ferramentas})  
