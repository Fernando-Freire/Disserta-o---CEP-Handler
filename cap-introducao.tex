...
As solução atuais de software livre de CEP disponíveis na atualidade ~\cite{Esper,DroolsFusion,WSO2CEP} %(e.g., \todo{Incluir aqui a citação a essas ferramentas})  
...
\begin{itemize}
  ...
  \item[2.] Implementação de um protótipo, com a arquitetura proposta, para o processamento de dados em tempo real por CEP com base em ferramentas de software livre. Este sistema foi desenvolvido para funcionar juntamente com a plataforma de software livre para cidades inteligentes InterSCity. %~\citep{del2019design}, do Instituto Nacional de Ciência e Tecnologia (INCT) da Internet do Futuro para Cidades Inteligentes~\citep{Interscitysite}.
