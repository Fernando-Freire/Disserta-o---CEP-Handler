...
\begin{itemize}
    ...
    \item Considerar na escolha os tipos e tamanhos de estados\todo{aqui é "tipos de estados" mesmo? Não seria "tamanho do estado"?} usados na detecção dos tipos de eventos alocados na instância sobrecarregada, como feito por \cite{6906776}%, para realocar o processamento de certos tipos de eventos de \texttt{CEP Worker}s. 
