...
\subsection{Distribuição de Tipos de Eventos Baseada em Desempenho}
...
Algumas destas técnicas% \todo{Algumas o quê? Técnicas de distribuição? Técnicas de reescrita de eventos?}
